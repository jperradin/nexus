...
config_clustering = c.ClusteringSettings(
    ...
    connectivity=["A", "B", "A"],
    cutoffs=[
        c.Cutoff(type1="A", type2="A", distance=1.1),
        c.Cutoff(type1="A", type2="B", distance=1.1),
        c.Cutoff(type1="B", type2="B", distance=1.1),
...
for j in j:
    ...
    for file in natsorted(files):
        ...
        config_general = c.GeneralSettings(
            ...
            export_directory=f"benchmarks/outputsAB/{j}",
