...
class LargestClusterSizeAnalyzer(BaseAnalyzer):
    def __init__(self, settings: Settings) -> None:
        ...
        self.fluctuations: Dict[str, List[float]] = {}
    ...
    def finalize(self) -> Dict[str, float]:
        ...
        return {"concentrations": self.concentrations, "largest_cluster_size": self.largest_cluster_sizes, "std": self.std, "fluctuations": self.fluctuations}
    ...
    def _write_data(self) -> None:
        ...
        with open(path, "a") as f:
            for connectivity in self.largest_cluster_sizes:
                ...
                f.write(f"{connectivity},{concentration},{largest_cluster_size},{std},{fluctuations}\n")
